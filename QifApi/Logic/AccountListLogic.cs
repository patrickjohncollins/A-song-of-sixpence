        ...
        public static void Export(StreamWriter writer, List<AccountListTransaction> list)
        {
            if ((list != null) && (list.Count > 0))
            {
                ...
                foreach (AccountListTransaction item in list)
                {
                    ...
                    writer.WriteLine(AccountInformationFields.CreditLimit + item.CreditLimit.ToString(CultureInfo.CurrentUICulture));
                    ...
                    writer.WriteLine(AccountInformationFields.StatementBalance + item.StatementBalance.ToString(CultureInfo.CurrentUICulture));
