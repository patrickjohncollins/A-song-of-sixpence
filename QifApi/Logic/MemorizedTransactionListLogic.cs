        ...
        internal static void Export(StreamWriter writer, List<MemorizedTransactionListTransaction> list)
        {
            if ((list != null) && (list.Count > 0))
            {
                ...
                foreach (MemorizedTransactionListTransaction item in list)
                {
                    ...
                    writer.WriteLine(MemorizedTransactionListFields.AmortizationCurrentLoanBalance + item.AmortizationCurrentLoanBalance.ToString(CultureInfo.CurrentUICulture));
                    ...
                    writer.WriteLine(MemorizedTransactionListFields.AmortizationInterestRate + item.AmortizationInterestRate.ToString(CultureInfo.CurrentUICulture));

                    writer.WriteLine(MemorizedTransactionListFields.AmortizationNumberOfPaymentsAlreadyMade + item.AmortizationNumberOfPaymentsAlreadyMade.ToString(CultureInfo.CurrentUICulture));

                    writer.WriteLine(MemorizedTransactionListFields.AmortizationNumberOfPeriodsPerYear + item.AmortizationNumberOfPeriodsPerYear.ToString(CultureInfo.CurrentUICulture));

                    writer.WriteLine(MemorizedTransactionListFields.AmortizationOriginalLoanAmount + item.AmortizationOriginalLoanAmount.ToString(CultureInfo.CurrentUICulture));

                    writer.WriteLine(MemorizedTransactionListFields.AmortizationTotalYearsForLoan + item.AmortizationTotalYearsForLoan.ToString(CultureInfo.CurrentUICulture));

                    writer.WriteLine(MemorizedTransactionListFields.Amount + item.Amount.ToString(CultureInfo.CurrentUICulture));
