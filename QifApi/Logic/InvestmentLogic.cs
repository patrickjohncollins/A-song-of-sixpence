        ...
        internal static void Export(StreamWriter writer, List<InvestmentTransaction> list)
        {
            if ((list != null) && (list.Count > 0))
            {
                ...
                foreach (InvestmentTransaction item in list)
                {
                    ...
                    writer.WriteLine(InvestmentAccountFields.AmountTransferred + item.AmountTransferred.ToString(CultureInfo.CurrentUICulture));
                    ...
                    writer.WriteLine(InvestmentAccountFields.Commission + item.Commission.ToString(CultureInfo.CurrentUICulture));
                    ...
                    writer.WriteLine(InvestmentAccountFields.Price + item.Price.ToString(CultureInfo.CurrentUICulture));

                    writer.WriteLine(InvestmentAccountFields.Quantity + item.Quantity.ToString(CultureInfo.CurrentUICulture));
                    ...
                    writer.WriteLine(InvestmentAccountFields.TransactionAmount + item.TransactionAmount.ToString(CultureInfo.CurrentUICulture));
