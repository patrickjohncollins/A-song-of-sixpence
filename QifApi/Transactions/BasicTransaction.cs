...
namespace QifApi.Transactions
{
    ...
    public class BasicTransaction : TransactionBase
    {
        ...
        {
            return string.Format(Resources.Culture, Resources.BasicTransactionDisplay, this.Date.ToString("d", CultureInfo.CurrentUICulture), this.Payee, this.Amount.ToString("C2", CultureInfo.CurrentUICulture));
        }
    }
}