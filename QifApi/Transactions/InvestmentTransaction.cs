...
namespace QifApi.Transactions
{
    ...
    public class InvestmentTransaction : TransactionBase
    {
        ...
        {
            return string.Format(Resources.Culture, Resources.InvestmentTransactionDisplay, this.Date.ToString("d", CultureInfo.CurrentUICulture), this.TextFirstLine, this.TransactionAmount.ToString("C2", CultureInfo.CurrentUICulture));
        }
    }
}
